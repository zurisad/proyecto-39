...
function preload(){
  ...
  gameOverImg = loadImage("gameOverr.png");
...
function draw() {
  ...
  textSize(23);
  text("Score: "+ score, displayWidth/2+450,50);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(displayWidth+50,height-95,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 120 === 0) {
    ...
    cloud.y = Math.round(random(100,280));
